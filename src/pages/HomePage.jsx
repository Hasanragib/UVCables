...
export default function HomePage() {
  const { PRODUCTS, INDUSTRIES, USE_CASES, setUcFilter, setFilterMode } = useApp();
  ...
  return (
    <>
      ...
      <section className="section" aria-labelledby="categories-heading">
        <div className="container">
          <div className="section-head">
            ...
            <h2 className="section-title" id="categories-heading">Find Cables</h2>
          ...
          <div className="uc-btn-grid" role="list">
            {USE_CASES.filter(uc => uc.id !== 'all').map(uc => (
              <Link
                ...
                role="listitem"
                className="uc-btn"
                onClick={() => { setFilterMode('usecase'); setUcFilter(uc.id); }}
      ...
      {/* ── FEATURED PRODUCTS ── */}
      <section className="section section--subtle" aria-labelledby="featured-heading">
        <div className="container">
          <div className="section-head">
            <div className="section-label">Our Range</div>
            <h2 className="section-title" id="featured-heading">Featured Cables</h2>
            <p className="section-desc">
      ...
      <section className="section" aria-labelledby="why-heading">
        <div className="container">
          <div className="section-head">
            ...
            <h2 className="section-title" id="why-heading">Built on Three Decades of Trust</h2>
            <p className="section-desc">A focused manufacturer committed to quality, flexibility, and fast delivery.</p>
          </div>
      ...
      {/* ── INDUSTRIES STRIP ── */}
      <section className="section section--subtle" aria-labelledby="ind-heading">
        <div className="container">
          <div className="section-head">
            <div className="section-label">Industries</div>
            <h2 className="section-title" id="ind-heading">Who We Supply To</h2>
          </div>
          <div className="industry-grid">
            {INDUSTRIES.map(ind => (
          ...
          <div style={{ textAlign: 'center', marginTop: 40 }}>
            <Link to="/industries" className="btn btn--ghost">All →</Link>
          </div>
        </div>
      </section>

      {/* ── CTA BAND ── */}
      <section style={{ background: 'var(--navy)', padding: '60px 0' }} aria-labelledby="cta-heading">
        <div className="container" style={{ textAlign: 'center' }}>
          <h2 id="cta-heading" style={{ color: '#fff', fontSize: 'clamp(22px, 3vw, 36px)', fontWeight: 900, marginBottom: 12, letterSpacing: '-0.025em' }}>
            Need a Custom Cable Quote?
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: 15, marginBottom: 28, maxWidth: 480, margin: '0 auto 28px' }}>
            Tell us your specifications — voltage, conductor size, length, IS standard — and we'll respond within 1 business day.
          </p>
          <Link to="/contact" className="btn btn--primary" style={{ fontSize: 15, padding: '13px 32px' }}>
            Get a Free Quote →
          </Link>
        </div>
      </section>
